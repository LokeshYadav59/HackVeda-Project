...
if (text.charAt(i) == ' ')
 ...
 //if the character is lowercase, make it

  //uppercase

 if (Character.isLowerCase(text.charAt(i)))
 toEncrypt += Character.toUpperCase
...
(text.charAt(i));
 ...
 //shift the current letter of the message with given
...
positions);
 ...
 //if the ASCII code exceeds Z, then bring it back in
...
positions);
 ...
 //if the ASCII code exceeds A, then bring it back in
